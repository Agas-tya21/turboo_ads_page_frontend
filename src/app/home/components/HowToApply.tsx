...
// The brand color constant (Note: The value is red)
const BFI_BLUE = "#FE0000";

const HowToApply = () => (
  <section className="bg-red-50 py-20">
    <div className="container mx-auto px-6 text-center">
      {/* Heading updated to use BFI_BLUE */}
      <h2 className="text-4xl font-bold mb-2" style={{ color: BFI_BLUE }}>
      ...
      <div className="grid md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col items-center">
          {/* Icon wrapper styled with BFI_BLUE */}
          <div className="bg-red-100 p-6 rounded-2xl mb-6 flex justify-center items-center w-28 h-28" style={{ color: BFI_BLUE }}>
            {/* Removed text-red-700 to inherit color */}
